...
- `timeseries_char_time_s`, `timeseries_char_power_total_w`, `timeseries_char_power_mech_w`
  (`Sigma|tau*omega|`), `timeseries_char_dba` (recorded acoustics, with a steady-state joint-model
...
| `MotionMetricsCalculator` | `motion_metrics` | `velocity_mean`, `velocity_max`, `jerk_mean` | m/s, m/s, m/s^3 |
