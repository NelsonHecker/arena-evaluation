...
class ProcessingPipeline:
    ...
    def process_run(self, run: RunDescriptor, force_extract: bool = False) -> pathlib.Path | None:
        ...
        for robot_name, bundle in bundles.items():
            ...
            for field in ("odom", "scan", "cmd_vel", "joint_states", "peds", "collision_events", "collision_monitor_state", "plan", "initialpose", "tf", "tf_static", "tf_gt", "semantic_snapshot", "semantic_events"):
